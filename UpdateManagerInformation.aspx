<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UpdateManagerInformation.aspx.cs" Inherits="UpdateManagerInformation" %>
	...
	<div id="container">
		...
		<div id="content">
            ...
            <tr><td class ="auto-style2">Town</td><td class="newTable">
                ...
                <asp:Button ID="SubmitButton" CssClass="newButton" runat="server" Text="Update" OnClick="SubmitButton_Click"/>
