	...
	<div id="container">
		...
		<div id="content">
			<div id="main">
                ...
                <table>
                    <tr>
                        <td>An email has been sent with your username and password.</td>   
                    </tr>
                    <tr>
                        <td><asp:Button ID="CreatePostButton"  class="button" runat="server" Text="Go to Login Page" CssClass="newButton" OnClick="CreatePostButton_Click"  /></td>    
                    </tr>
