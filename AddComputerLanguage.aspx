<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddComputerLanguage.aspx.cs" Inherits="AddComputerLanguage" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Add Computer Language</title>
	...
	<div id="container">
		...
		<div id="content">
			<div id="main">
				...
				<h1 class="pagetitle">add computer language</h1>
				...
				<br /><br />
                                <table border="0">
                                    <tr>
                                        ...
                                        <td class="newTable">
                                            <asp:TextBox ID="Language" Width="268" runat="server"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="auto-style2">Prificiency</td>
                                        <td class="newTable">
                                            <asp:DropDownList ID="ProficiencyDropDownList" CssClass="newdrop" runat="server" Width="180">
                                            <asp:ListItem Value="0">Beginner</asp:ListItem>
                                            <asp:ListItem Value="1">Intermediate</asp:ListItem>
                                            <asp:ListItem Value="2">Expert</asp:ListItem>
                                            </asp:DropDownList>
                                        </td>
                                    </tr>
                                </table>
                                <table border="0">
                                    <tr>
                                        <td>
                                            <asp:Button ID="SubmitAndCloseButton" CssClass="newButton" runat="server" Text="Submit and Close" OnClick="SubmitAndCloseButton_Click" />
                                        </td>
                                        <td>
