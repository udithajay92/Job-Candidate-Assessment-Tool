<%@ Page Language="C#" AutoEventWireup="true" CodeFile="addPhd.aspx.cs" Inherits="addPhd" %>
	...
	<div id="container">
		...
		<div id="content">
			<div id="main">
				...
				<h1 class="pagetitle_new">add PhD</h1>
				...
				<br /><br />
                    <table>
                        <tr>
                            ...
                            <td class="newTable">
                                <asp:TextBox ID="SubjectTextBox" width="260" runat="server"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
