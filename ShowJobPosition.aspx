<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ShowJobPosition.aspx.cs" Inherits="ShowJobPosition" %>
	...
	<div id="container">
			...
			<div id="top-right">
				<div id="top-navigation">
					<ul id="topnav">
						...
						<li><a>My CV</a>
							<ul>
								<li><a href="Add_Personal_Information.aspx">Personal Information</a></li>
								<li><a href="Add_Personal_Information.aspx">Edit Personal Information</a></li>
                                <li><a href="AddPhoneNumber.aspx">Add Phone Number</a></li>
                                <li><a href="Add_Computer_Language.aspx">Add a Computer Language</a></li>
                                <li><a href="Add_First_Degree.aspx">Add a First Degree</a></li>
                                <li><a href="Add_Master_Degree.aspx">Add a Master's Degree</a></li>
                                <li><a href="Add_PhD.aspx">Add a PhD</a></li>
                                <li><a href="Add_Soft_Skill.aspx">Add a Soft Skill</a></li>
                                <li><a href="Add_Seeking_Job.aspx">Add a Seeking Job Position</a></li>
		...
		<div id="content">
			<div id="main">
				...
				<h1 class="pagetitle_new">Description</h1>
                    
				<br /><br />
                  
                <table class="newTable">
                    <tr>
                        <td colspan="2"><h2><asp:Label ID="TitleLabel" runat="server" Text="Label"></asp:Label></h2></td>
                    </tr>
                     <tr>
                        <td colspan="2"><asp:Label ID="JobType" runat="server" Text="Label"></asp:Label></td>
                    </tr>
                     <tr>
                        <td colspan="2"></td>
                    </tr>
                     <tr>
                        <td colspan="2"><asp:Button ID="ApplyButton" runat="server" Text="Apply for this Position" CssClass="newButton" OnClick="ApplyButton_Click" /></td>
                    </tr>
                    <tr>
                        <td colspan="2"> <asp:Label ID="PositionId" runat="server" Visible="false" Text="Label"></asp:Label>
                            <asp:Label ID="CreatorsId" runat="server" Visible="false" Text="Label"></asp:Label>
                        </td>
                    </tr>
                     <tr>
                        <td class="cvTableTextright">Employer</td>
                         <td><asp:Label ID="EmployerLabel" runat="server" Text="Label"></asp:Label></td>
                    </tr>
                    <tr>
                        <td class="cvTableTextright">First Quality</td>
                         <td><asp:Label ID="FirstQuality" runat="server" Text="Label"></asp:Label> &nbsp;(<asp:Label ID="FirstQualityType" runat="server" Text="Label"></asp:Label>)</td>
                    </tr>
                    <tr>
                        <td class="cvTableTextright">Second Quality</td>
                         <td><asp:Label ID="SecondQuality" runat="server" Text="Label"></asp:Label> &nbsp;(<asp:Label ID="SecondQualityType" runat="server" Text="Label"></asp:Label>)</td>
                    </tr>
                    <tr>
                        <td class="cvTableTextright">Third Quality</td>
                         <td><asp:Label ID="ThirdQuality" runat="server" Text="Label"></asp:Label> &nbsp;(<asp:Label ID="ThirdQualityType" runat="server" Text="Label"></asp:Label>)</td>
                    </tr>
                    <tr>
                        <td class="cvTableTextright">Description</td>
                         <td><asp:Label ID="DescriptionLabel" runat="server" Text="Label"></asp:Label></td>
                    </tr>
                    <tr>
                        <td class="cvTableTextright">Salary</td>
                         <td><asp:Label ID="Salary" runat="server" Text="Label"></asp:Label></td>
                    </tr>
                    <tr>
                        <td class="cvTableTextright">Minimum Age Requirement</td>
                         <td><asp:Label ID="MinAge" runat="server" Text="Label"></asp:Label></td>
                    </tr>
                    <tr>
                        <td class="cvTableTextright">Maximum Age Requirement</td>
                         <td><asp:Label ID="MaxAge" runat="server" Text="Label"></asp:Label></td>
                    </tr>
                    <tr>
                        <td class="cvTableTextright">Experience</td>
                         <td><asp:Label ID="Experience" runat="server" Text="Label"></asp:Label></td>
                    </tr>
                </table>                   
