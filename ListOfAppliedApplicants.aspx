<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ListOfAppliedApplicants.aspx.cs" Inherits="ListOfAppliedApplicants" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Post in Forum</title>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $("#detailDiv").hide();
        $("#showDetailDivButton").click(function () {
	...
	<div id="container">
		...
		<div id="content">
			<div id="main">
				...
				<h1 class="pagetitle_new">applied applicants</h1>
                    
				<br />
                          
                    <asp:GridView ID="ApplicantsListGridView" runat="server" OnRowCreated="GridViewRowCreated"></asp:GridView>  

                    <br />
                    <table>
                        <tr>
                            <td><asp:Button ID="RefreshRatingsButton" runat="server" Text="Refresh Ratings" CssClass="newButtonSP" OnClick="RefreshRatingsButton_Click" /></td>
                            <td><input id="showDetailDivButton" type="button" class="newButtonSP" value="Send Emails for Interview" /></td>
                        </tr>
                    </table>
                    <br />
                    ...
                    <table>
                        <tr>
                            <td class="cvTableTextright">Enter Starting Time</td>
                            <td><asp:TextBox ID="StartingTimeTextBox" runat="server"></asp:TextBox></td>
                        </tr>
                        <tr>
                            <td class="cvTableTextright">Date</td>
                            <td><asp:TextBox ID="DateTextBox" runat="server"></asp:TextBox></td>
                        </tr>
                        <tr>
                            <td class ="cvTableTextright">Venue</td>
                            <td><asp:TextBox ID="VenueTextBox" runat="server"></asp:TextBox></td>
                        </tr>
                        <tr>
                            <td colspan="2"><asp:Button ID="SendForInterviewButton" runat="server" CssClass="newButtonSP1" Text="Call selected applicants for interview" OnClick="SendForInterviewButton_Click" /></td>
                        </tr>
                    </table>
                    </div>
