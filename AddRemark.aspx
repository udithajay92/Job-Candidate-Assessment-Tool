<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddRemark.aspx.cs" Inherits="AddRemark" %>
	...
	<div id="container">
		...
		<div id="content">
			<div id="main">
				...
				<h1 class="pagetitle_new">add remarks</h1>
                    
				<br /><br />
                  
                    Why do you think  you should be selected for this position? (Please state a reason under 64 characters.)
                    <br />
        <br />
        <asp:TextBox ID="RemarkTextBox" runat="server" Width="580"></asp:TextBox>
        <br />
                    <br />
        <asp:Button ID="Button1" runat="server" Text="Apply for Position" CssClass="newButton" OnClick="ApplyButton_Click" />
