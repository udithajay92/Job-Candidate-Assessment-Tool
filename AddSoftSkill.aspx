<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddSoftSkill.aspx.cs" Inherits="AddSoftSkill" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Add a Soft Skill</title>
	...
	<div id="container">
		...
		<div id="content">
			<div id="main">
				...
				<h1 class="pagetitle_new">add a soft skill</h1>
                    
				<br /><br />
                  <table>
                        <tr>
                            <td class="auto-style2">Soft Skill</td>
                            <td class="newTable">
                                <asp:TextBox ID="SoftSkillTextBox" Width="260" runat="server"></asp:TextBox>
                            </td>
                        </tr>
                    </table>
                    <table>
