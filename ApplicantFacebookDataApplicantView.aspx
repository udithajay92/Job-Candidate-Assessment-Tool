<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ApplicantFacebookDataApplicantView.aspx.cs" Inherits="ApplicantFacebookDataApplicantView" %>
	...
	<div id="container">
		...
		<div id="content">
			<div id="main">
				...
				<h1 class="pagetitle_new">facebook account</h1>
                    
				<br /><br />
                  
                   <table>
                        <tr>
                            <td><asp:Image ID="Picture" runat="server" /></td>
                            <td><asp:Label ID="NameLabel" runat="server" Text=""></asp:Label></td>
                        </tr>
                        <tr>
                            <td class="cvTableTextright">Link</td>
                            <td><asp:HyperLink ID="HyperLink" runat="server"></asp:HyperLink></td>
                        </tr>
                    </table>
                    <br />
                    <h1 class="pagetitle">basic information</h1>
                    <table>
                        <tr>
                            <td class="cvTableTextright">Birthday</td>
                            <td><asp:Label ID="BirthdayLabel" runat="server" Text=""></asp:Label></td>
                        </tr>
                        <tr>
                            <td class="cvTableTextright">Gender</td>
                            <td><asp:Label ID="GenderLabel" runat="server" Text=""></asp:Label></td>
                        </tr>
                        <tr>
                            <td class="cvTableTextright">Home Town</td>
                            <td><asp:Label ID="HometownLabel" runat="server" Text=""></asp:Label></td>
                        </tr>
                    </table>
                    ...
                    <table>
                        <tr>
                            <td class="cvTableTextright">Email</td>
                            <td><asp:Label ID="EmailLabel" runat="server" Text=""></asp:Label></td>
                        </tr>
                   </table>
                    <br />

                    <h1 class="pagetitle">other information</h1>
                    <table>
                        <tr>
                            <td class="cvTableTextright">Education</td>
                            <td><asp:Label ID="EducationLabel" runat="server" Text=""></asp:Label></td>
                        </tr>
                        <tr>
                            <td class="cvTableTextright">Work</td>
                            <td><asp:Label ID="WorkLabel" runat="server" Text=""></asp:Label></td>
                        </tr>
                        <tr>
                            <td class="cvTableTextright">Books Read</td>
                            <td><asp:Label ID="BooksLabel" runat="server" Text=""></asp:Label></td>
                        </tr>
                        <tr>
                            <td class="cvTableTextright">Religion</td>
                            <td><asp:Label ID="ReligionLabel" runat="server" Text=""></asp:Label></td>
                        </tr>
                        <tr>
                            <td class="cvTableTextright">Bio</td>
                            <td><asp:Label ID="BioLabel" runat="server" Text=""></asp:Label></td>
                        </tr>
                    </table>
                    <br />

                    <h1 class="pagetitle">facebook account information</h1>

                    <table>
                        <tr>
                            <td class="cvTableTextright">Number of Friends</td>
                            <td><asp:Label ID="FriendsLabel" runat="server" Text=""></asp:Label></td>
                        </tr>
                        <tr>
                            <td class="cvTableTextright">Last Three Status</td>
                            <td><asp:Label ID="StatusLabel" runat="server" Text=""></asp:Label></td>
                        </tr>
                        <tr>
                            <td class="cvTableTextright">Events Attending</td>
                            <td><asp:Label ID="EventsLabel" runat="server" Text=""></asp:Label></td>
                        </tr>
                    </table>                     
