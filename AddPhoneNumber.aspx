<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddPhoneNumber.aspx.cs" Inherits="AddPhoneNumber" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Add Personal Phone Number</title>
	...
	<div id="container">
		...
		<div id="content">
			<div id="main">
				...
				<h1 class="pagetitle_new">add phone number</h1>
				...
				<br /><br />
                    <table>
                        <tr>
                            ...
                            <td class="newTable">
                                <asp:TextBox ID="PhoneNumberTextBox" width="260" runat="server"></asp:TextBox>
                            </td>
                        </tr>
                    </table>
                    <table>
                        <tr>
                            <td>
                                <asp:Button ID="SubmitAndCloseButton" runat="server" CssClass="newButton" Text="Submit & Close" OnClick="SubmitAndCloseButton_Click" />
