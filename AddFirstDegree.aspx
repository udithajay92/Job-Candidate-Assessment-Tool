<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddFirstDegree.aspx.cs" Inherits="AddFirstDegree" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Add First Degree</title>
	...
	<div id="container">
		...
		<div id="content">
			<div id="main">
				...
				<h1 class="pagetitle">add first degree</h1>
                    
				<br /><br />
                    <table border="0">
                        <tr>
                            <td class="auto-style2">Degree Name</td>
                            <td class="newTable"><asp:TextBox ID="DegreeNameTextBox" Width="260" runat="server"></asp:TextBox></td>
                        </tr>
                        <tr>
                            <td class="auto-style2">Name of Universty</td>
                            <td class="newTable">
                                <asp:TextBox ID="UniversityNameTextBox" Width="260" runat="server"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td class="auto-style2">Gratuated Year</td>
                            <td class="newTable">
                    ...
                    <table border="0">
                        <tr>
                            <td>
                                <asp:Button ID="SubmitAndCloseButton" CssClass="newButton" runat="server" Text="Submit & Close" OnClick="SubmitAndCloseButton_Click" />
                            </td>
                            <td>
                                <asp:Button ID="SubmitAndNewButton" CssClass ="newButton" runat="server" Text="Submit & New" OnClick="SubmitAndNewButton_Click" />
                            </td>
                        </tr>
                    </table>
