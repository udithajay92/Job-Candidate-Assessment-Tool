<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PostInForumManager.aspx.cs" Inherits="PostInForumManager" %>
	...
	<div id="container">
		...
		<div id="content">
			<div id="main">
				...
				<h1 class="pagetitle_new">connect with the community</h1>
				...
				<br /><br />
                           <table>
                               <tr>
                                   ...
                                   <td class ="newTable">
                                       <asp:DropDownList ID="ListOfForumsDropDownList" CssClass ="newdrop" runat="server" AutoPostBack="true"></asp:DropDownList>
                                   </td>
                               </tr>
                               <tr>
                                   <td class="newTableText">
                                   ...
                                   <td class="newTable">
                                       <asp:TextBox ID="TextBox2" TextMode ="MultiLine" runat="server" Height="64px" Width="367px"></asp:TextBox>
                                   </td>
                               </tr>
                               <tr>
                                   <td colspan="2">
                                       <asp:Button ID="CreatePostButton" class="newButton" runat="server" Text="Post" Width="110px" Height="26px" OnClick="CreatePostButton_Click" />
                                   </td>
                               </tr>
                           </table>  
