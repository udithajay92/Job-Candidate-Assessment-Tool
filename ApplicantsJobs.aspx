<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ApplicantsJobs.aspx.cs" Inherits="ApplicantsJobs" %>
	...
	<div id="container">
		...
		<div id="content">
			<div id="main">
				...
				<h1 class="pagetitle_new">sought jobs</h1>
                    
				<br /><br />
                  
                       <asp:GridView ID="JobsGridView" runat="server"></asp:GridView>   

                    <br /><br />
                    
                    <h1 class="pagetitle_new">Applied jobs</h1>   

                    <br /><br />
                    
                    <asp:GridView ID="AppliedJobsGridView" runat="server"></asp:GridView>           
