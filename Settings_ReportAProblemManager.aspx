<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Settings_ReportAProblemManager.aspx.cs" Inherits="Settings_ReportAProblemManager" %>
	...
	<div id="container">
		...
		<div id="content">
			<div id="main">
				...
				<h1 class="pagetitle_new">report a problem</h1>

                    <table>
                        <tr>
                            <td>Problem</td>
                            <td><asp:TextBox ID="problem" width="420" runat="server"></asp:TextBox></td>
                        </tr>
                        <tr>
                            <td>Description</td>
                            <td><asp:TextBox ID="description" TextMode="MultiLine" runat="server" Height="200px" Width="420px"></asp:TextBox></td>     
                        </tr>
                        <tr>
                            <td colspan="2">
                                <asp:Button ID="SendEmailButton" runat="server" CssClass="newButton" Text="Send" OnClick="SendEmailButton_Click" /></td>
                        </tr>
                    </table>
