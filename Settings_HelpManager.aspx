<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Settings_HelpManager.aspx.cs" Inherits="Settings_HelpManager" %>
	...
	<div id="container">
			...
			<div id="top-right">
				<div id="top-navigation">
					<ul id="topnav">
						...
						<li><a href="ContactUsManager.aspx">ContactContact Us
		...
		<div id="content">
			<div id="main">
				...
				<h1 class="pagetitle_new">help</h1>
