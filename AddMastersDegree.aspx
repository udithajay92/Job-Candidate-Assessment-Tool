<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddMastersDegree.aspx.cs" Inherits="AddMastersDegree" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Add Master's Degree</title>
	...
	<div id="container">
		...
		<div id="content">
			<div id="main">
				...
				<h1 class="pagetitle">add master degree</h1>
                    
				<br /><br />
                    <table>
                        <tr>
                            <td class="auto-style1">Master's Degree</td>
                            <td class="newTable">
                                <asp:TextBox ID="MastersDegreeNameTextBox" Width="260" runat="server"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td class="auto-style1">Name of University</td>
                            <td class="newTable">
                               <asp:TextBox ID="UniversityNameTextBox" Width="260" runat="server"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td class="auto-style1">Gratuated Year</td>
                            <td class="newTable">
                                <asp:TextBox ID="YearTextBox" Width="260" runat="server"></asp:TextBox>
                            </td>
                        </tr>
                    </table>
                    <table>
                        <tr>
                            <td>
                                <asp:Button ID="SubmitAndCloseButton" runat="server" class="newButton" Text="Submit and Close" OnClick="SubmitAndCloseButton_Click" />

                            </td>
                            <td>
                                <asp:Button ID="SubmitAndNewButton" CssClass="newButton" runat="server" Text="Submit and New" OnClick="SubmitAndNewButton_Click" />
                            </td>
                        </tr>
                    </table>
                    <asp:Label ID="ConfirmationLabel" runat="server" CssClass="red"></asp:Label>
                    <asp:Label ID="FunctionCallerLabel" runat="server"></asp:Label>
